...
def plot_mst_simple(model_labels, true_labels, embedding_filename, sigma, min_cluster, one_vs_all,X_embedded, method,knn_opt=None,dimred='dimred_method'):
    ...
    #plt.show()
def multiclass_mst_accuracy(X_embedded, true_label,df_all,av_peaks=15, too_big_factor = 0.4):
...
def main():
    ...
    run_main('LCJAN_3D_29July9AM'+'_', n_eachsubtype=None, randomseedval=randomseedval)
