...
def plot_peaks(X,Y, positions, image,ax1,ax2, density_type):
    ...
    print('coord shape' ,np.vstack((xco,yco)).shape)
    #print(Y)
    ...
    for dataset_version in dataset_version_range:
        ...
        for perplexity in perp_range:
            ...
            for tsne_version in tsne_version_range:
                ...
                if n_total < 500000:
                    predict_class_aggregate_dbscan, df_accuracy_dbscan, eps_opt, min_cluster_size_opt_dbscan = run_dbscan(X_embedded, n_cancer, true_label, dataset_version, tsne_version, embedding_filename, tsne_runtime, mu_edge,std_edge)
                ...
                if n_total < 500000:model_dbscan = DBSCAN(eps_opt, min_cluster_size_opt_dbscan, tooclose_factor = 5).fit(X_embedded)
