...
class MSTClustering3D(BaseEstimator, ClusterMixin):
    ...
    def fit(self, X, y=None):
        ...
        if max_labels < 0: #SOM 200
            cur_sigma_factor = -2.5#-1.5
            ...
            while len(set(labels)) < 500 and cur_tooclosefactor <= 50: #on Sep13 changing to. was 30
                ...
                while updated == True:
                    ...
                    if len(set(labels)) <= max_labels:
                        ...
                        print('updated num labels: ', len(set(labels)), 'at sigma factor ', cur_sigma_factor)
                        return self
                cur_tooclosefactor = cur_tooclosefactor + 1
        ...
        if max_labels < 2000:
            ...
            cur_tooclosefactor = 0
            updated = True
            while len(set(labels)) < 200 and cur_tooclosefactor <= 50:# was 30 until sep 13 ,was 500 until 21sept
                updated = True
                while updated == True:
                    X_dict_mean, X_dict, labels, updated = self.too_close(X_dict_mean, X_dict, labels, mu,
                                                                          cur_tooclosefactor=cur_tooclosefactor)
                    if len(set(labels)) <= max_labels:
                        ...
                        self.tooclosefactor = cur_tooclosefactor
                        self.sigma_factor = cur_sigma_factor
                        print('updated num labels: ', len(set(labels)), 'at sigma factor ', cur_sigma_factor, 'and too close factor ', cur_tooclosefactor)
                        return self
        ...
        cur_tooclosefactor = 0
        updated = True
        while len(set(labels)) < 200 and cur_tooclosefactor <= 50:  # was 500 until 21sept
            updated = True
            while updated == True:
                X_dict_mean, X_dict, labels, updated = self.too_close(X_dict_mean, X_dict, labels, mu,
                                                                      cur_tooclosefactor=cur_tooclosefactor)
                if len(set(labels)) <= max_labels:
                    ...
                    return self
            cur_tooclosefactor = cur_tooclosefactor + 5#5# 0.2 for SOM  # 10
            print(cur_tooclosefactor, 'is the current too close factor')
        ...
        while len(set(labels)) < 200 and cur_tooclosefactor <= 50: #was 500 until 21sept
            ...
            while updated == True:
                ...
                if len(set(labels)) <= max_labels:
                    ...
                    return self
            cur_tooclosefactor = cur_tooclosefactor+1#5 #0.2(SOM 0.2) # 5#10
        cur_sigma_factor = 1.5
        X_dict_mean, X_dict, labels = self.apply_sigma(cur_sigma_factor)
        updated = True
        cur_tooclosefactor = 0
        while cur_tooclosefactor <= 50 and len(set(labels)) < 2000:#testing on 20th sep from 30 to 50
            updated = True
        ...
        X_dict_mean, X_dict, labels = self.apply_sigma(cur_sigma_factor)
        cur_tooclosefactor = 0
        while cur_tooclosefactor <= 50 and len(set(labels)) < 500: #testing on 20th sep from 30 to 50
            updated = True
            # print('updated tooclosefactor: ', cur_tooclosefactor)
            while updated == True:
                X_dict_mean, X_dict, labels, updated = self.too_close(X_dict_mean, X_dict, labels, mu,
        ...
        X_dict_mean, X_dict, labels = self.apply_sigma(cur_sigma_factor)
        cur_tooclosefactor = 0
        while cur_tooclosefactor <= 50 and len(set(labels)) < 700:  # 50 will be largest until sep21st
        ...
        X_dict_mean, X_dict, labels = self.apply_sigma(cur_sigma_factor)
        cur_tooclosefactor = 0
        while cur_tooclosefactor <= 90 and len(set(labels)) < 700:
            updated = True
            # print('updated tooclosefactor: ', cur_tooclosefactor)
            while updated == True:
                X_dict_mean, X_dict, labels, updated = self.too_close(X_dict_mean, X_dict, labels, mu,
        ...
        cur_tooclosefactor = 0
        X_dict_mean, X_dict, labels = self.apply_sigma(cur_sigma_factor)
        while len(set(labels)) > max_labels and len(set(labels ))<500:
            updated = True
            while updated == True:
                X_dict_mean, X_dict, labels, updated = self.too_close(X_dict_mean, X_dict, labels, mu,
                                                                      cur_tooclosefactor=cur_tooclosefactor)
        ...
        while len(set(labels)) > max_labels and len(set(labels)) < 500:
            ...
            cur_tooclosefactor = cur_tooclosefactor*2
        cur_sigma_factor = 10
