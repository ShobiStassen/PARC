...
#will now try to make some changes to the Louvain_igraphJac24Spept.py file but can revert to this file if needed
...
def run_mainlouvain(X_data,true_label, self_loop = False,LV_graphinput_file_name =None, LV_plot_file_name =None, too_big_factor = 0.4, knn_in = 30,small_pop = 10,dist_std = 1, keep_all_dist= True,jac_std=0.3,jac_weighted_edges = True, n_iter_leiden = 5,partition_seed=0, parc_method='leiden'):
    list_roc = []
